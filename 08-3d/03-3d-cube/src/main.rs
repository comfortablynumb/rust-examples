...
struct Uniforms {
    ...
    // cgmath matrices are column-major, which matches WGSL
    mvp: [[f32; 4]; 4],
}
...
struct State {
    ...
    num_indices: u32,
    // Uniform buffer and bind group for transformation matrices
...
impl State {
    async fn new(window: Window) -> Self {
        ...
        // Depth testing prevents triangles behind other triangles from being drawn
        ...
        let render_pipeline = device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            depth_stencil: Some(wgpu::DepthStencilState {
                ...
                depth_compare: wgpu::CompareFunction::Less, // Closer fragments pass
    ...
    fn update(&mut self) {
        ...
        // Model matrix: rotates the cube
        let model = cgmath::Matrix4::from_angle_x(cgmath::Rad(self.rotation))
            * cgmath::Matrix4::from_angle_y(cgmath::Rad(self.rotation * 0.7));
        ...
        // Update uniforms
        self.uniforms.update_mvp(model, view, projection);
